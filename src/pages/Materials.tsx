...
import { Package, Search, Loader2, Plus, ClipboardList, AlertCircle } from 'lucide-react';
...
import { WorkOrderCard } from '@/components/materials/WorkOrderCard';
...
const Materials = () => {
  ...
  const isError = linesError || suppliersError || inventoryError || woError;
      ...
      <div className="space-y-5">
        <div>
          <h2 className="text-lg font-semibold text-foreground flex items-center gap-2">
            <Package className="h-4 w-4 text-muted-foreground" /> Materials & Inventory
          </h2>
        </div>
